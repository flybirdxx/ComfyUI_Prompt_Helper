...
- 📋 **14个专业分类** - 覆盖电影制作的各个方面
- 🎲 **智能随机选择** - 每个属性支持随机功能，一键生成意想不到的创意组合
...
### 什么是随机功能？
随机功能是v0.1.2版本新增的创意工具，允许您在任何属性分类中选择"随机"选项，系统会自动从该分类的所有可用选项中随机选择一个。这个功能特别适合：
...
![随机功能演示](https://i.imgur.com/your-random-feature-screenshot.png)
